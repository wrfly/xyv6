    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="bills.php">
                        <i class="fa fa-money"></i> <span>账单管理</span>
                    </a>
                </li>
                <li>
                    <a href="user.php">
                        <i class="fa ion-android-people"></i> <span>查看用户</span>
                    </a>
                </li>
                <li>
                    <a href="vip_user.php?page=1">
                        <i class="fa ion-ios-people"></i> <span>VIP用户</span>
                    </a>
                </li>
                <li>
                    <a href="user_search.php">
                        <i class="fa ion-ios-search-strong"></i> <span>搜索用户</span>
                    </a>
                </li>
                <li  >
                    <a href="sysinfo.php">
                        <i class="fa fa-cog"></i> <span>系统信息</span>
                    </a>
                </li>
            </ul>
        </section>

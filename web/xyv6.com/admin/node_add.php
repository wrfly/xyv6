...
if(!empty($_POST)){
    ...
    $query = $node->Add($node_name,$node_type,$node_server,$node_ipv4,$node_method,$node_info,$node_status,$node_order);
    if($query){
                    ...
                    <form role="form" method="post" action="node_add.php">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input  class="form-control" name="node_name" value=".xyv6.com" >
                            </div>

                            <div class="form-group">
                                <label for="cate_title">节点地址</label>
                                <input  class="form-control" name="node_server" placeholder="IPV6地址" >
                                <p></p>
                                <input  class="form-control" name="node_ipv4" placeholder="IPV4地址" >
                            </div>

                            <div class="form-group">
                                <label for="cate_method">加密方式</label>
                                <input  class="form-control" name="node_method" value="aes-256-cfb" >
                            </div>

...
if( $uid != '' || $uid != 0 ){
    ...
    if($pw != $user_pwd || $pw == null || $user_pwd == null  ){
        ...
        header("Location:https://xyv6.kf5.com/user/login");
...
<div class="login-box">
    <div class="login-logo">
        ...
        <a href="https://xyv6.com"><b><?php echo $site_name;  ?></b></a>
    </div><!-- /.login-logo -->
    <div class="login-box-body cc">
        ...
        <a href="../reg.php" class="text-center">注册帐号</a>
        <a href="../resetpwd.php" class="text-center" style="float:right;" >忘记密码</a>
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.ok){
                        ...
                        window.setTimeout("location.href='https://xyv6.kf5.com/user/login'", 1000);
                    }else{
